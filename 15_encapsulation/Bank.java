...
//        this.numberBanknotesOneHundred = numberBanknotesOneHundred;
    ...
    public boolean withdrawMoney(int sum) {
        ...
        while (currentSum != 0) {
            ...
            if (currentSum > ONE_HUNDRED && (currentSum / ONE_HUNDRED) <= (numberBanknotesOneHundred) && currentSum % FIFTY != 10 && currentSum % FIFTY != 30) {
                currentOneHundred = currentSum / ONE_HUNDRED;
                currentSum -= currentOneHundred * ONE_HUNDRED;
            } else if (currentSum > ONE_HUNDRED && (currentSum / ONE_HUNDRED) > (numberBanknotesOneHundred)&& currentSum % FIFTY != 10 && currentSum % FIFTY != 30)  {
